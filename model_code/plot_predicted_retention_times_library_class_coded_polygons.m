function plot_predicted_retention_times_library_class_coded_polygons(calibration_analytes, library, t1_lib, t2_lib, modulation_period, prompt_output)
...
for class_index = 1:length(unique(library.class))
 ...
 for CN_index = unique(library.CN')
...
title('Simulated retention times of the constituent library','Color-coded by class with maximum-area polygons');
box on;
